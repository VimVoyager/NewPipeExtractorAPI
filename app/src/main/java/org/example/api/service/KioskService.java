...
//    public InfoItemsPage<StreamInfoItem> getKioskPage(int serviceId, String kioskId, Page page)
//            throws ExtractionException {
//        try {
//            logger.info("Extracting kiosk page for kioskId: {}, serviceId: {}", kioskId, serviceId);
//
//            StreamingService service = NewPipe.getService(serviceId);
//            KioskExtractor<?> extractor = service.getKioskList().getExtractorById(kioskId, null);
//
...
//        } catch (Exception e) {
//            logger.error("Failed to extract kiosk page for kioskId: {}, serviceId: {}",
//                    kioskId, serviceId, e);
//            throw new ExtractionException(e.getMessage(), e);
//        }
//    }
